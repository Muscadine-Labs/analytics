...
/**
 * Collect candidate Chainlink feed addresses from GraphQL hints and on-chain Morpho oracle immutables.
 */
...
/**
 * Among multiple feeds in a composite oracle, use the stalest update (conservative for risk).
 */
